...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'shorting_entries', COALESCE((
      ...
      WHERE se.weaver_challan_id = v_weaver_challan_id
    ), '[]'::jsonb),
  ...
  WHERE wc.id = v_weaver_challan_id;
